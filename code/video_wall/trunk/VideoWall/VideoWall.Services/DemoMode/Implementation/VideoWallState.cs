...
namespace VideoWall.ServiceModels.DemoMode.Implementation
{
    ...
    public enum VideoWallState
    {
        ...
        /// <summary>
        ///   When the application is inactive and a someone stands in front of the screen, the countdown starts ticking. After a certain time (e.g. after 5 seconds), the demo mode state is switched to inactive.
        /// </summary>
        Countdown
    }
}
